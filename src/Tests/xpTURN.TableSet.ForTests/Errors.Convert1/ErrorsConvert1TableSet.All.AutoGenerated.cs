...
using static Tests.Errors.Convert1.ErrorsConvert1TableSet;

namespace Tests.Errors.Convert1
{
    public partial class AllTypesData : Data, IMessage<AllTypesData>, IBufferMessage
    {
        #region Proto.Field
        public int Id;
        ...
        protected static readonly xpMapCodec<int, string> _mapString_3_codec
            = new (xpFieldHelper.SFixed32Codec, xpFieldHelper.StringCodec, 386, 13, 18);
        protected static readonly xpMapCodec<string, string> _mapAlias_3_codec
            = new (xpFieldHelper.StringCodec, xpFieldHelper.StringCodec, 394, 10, 18);
        protected static readonly xpMapCodec<SAMPLE_NUMBER, string> _mapEnum_3_codec
            = new (xpFieldCodecForEnum<SAMPLE_NUMBER>.EnumCodec, xpFieldHelper.StringCodec, 402, 8, 18);
        #endregion
        ...
        void IBufferMessage.InternalWriteTo(ref WriteContext ctx)
        {
            ...
            {
                ctx.WriteRawTag(186, 1);
                ctx.WriteMessage(SampleInfo_1);
            }
            RepeatedString().Write(ref ctx, ref ListTextAlias_2, 194);
            RepeatedBytes().Write(ref ctx, ref ListBytes_2, 202);
            RepeatedInt32().Write(ref ctx, ref ListInt32_2, 210);
            RepeatedInt64().Write(ref ctx, ref ListInt64_2, 218);
            RepeatedUInt32().Write(ref ctx, ref ListUInt32_2, 226);
            RepeatedUInt64().Write(ref ctx, ref ListUInt64_2, 234);
            RepeatedSInt32().Write(ref ctx, ref ListSInt32_2, 242);
            RepeatedSInt64().Write(ref ctx, ref ListSInt64_2, 250);
            RepeatedFixed32().Write(ref ctx, ref ListFixed32_2, 258);
            RepeatedFixed64().Write(ref ctx, ref ListFixed64_2, 266);
            RepeatedSFixed32().Write(ref ctx, ref ListSFixed32_2, 274);
            RepeatedSFixed64().Write(ref ctx, ref ListSFixed64_2, 282);
            RepeatedDouble().Write(ref ctx, ref ListDouble_2, 290);
            RepeatedFloat().Write(ref ctx, ref ListFloat_2, 298);
            RepeatedBool().Write(ref ctx, ref ListBoolean_2, 306);
            RepeatedEnum<SAMPLE_NUMBER>().Write(ref ctx, ref ListEnum_2, 314);
            RepeatedDateTime().Write(ref ctx, ref ListDateTime_2, 346);
            RepeatedTimeSpan().Write(ref ctx, ref ListTimeSpan_2, 354);
            RepeatedUri().Write(ref ctx, ref ListUri_2, 362);
            RepeatedGuid().Write(ref ctx, ref ListGuid_2, 370);
        ...
        public int CalculateSize()
        {
            ...
            size += RepeatedString().CalculateSize(ListTextAlias_2, 194);
            size += RepeatedBytes().CalculateSize(ListBytes_2, 202);
            size += RepeatedInt32().CalculateSize(ListInt32_2, 210);
            size += RepeatedInt64().CalculateSize(ListInt64_2, 218);
            size += RepeatedUInt32().CalculateSize(ListUInt32_2, 226);
            size += RepeatedUInt64().CalculateSize(ListUInt64_2, 234);
            size += RepeatedSInt32().CalculateSize(ListSInt32_2, 242);
            size += RepeatedSInt64().CalculateSize(ListSInt64_2, 250);
            size += RepeatedFixed32().CalculateSize(ListFixed32_2, 258);
            size += RepeatedFixed64().CalculateSize(ListFixed64_2, 266);
            size += RepeatedSFixed32().CalculateSize(ListSFixed32_2, 274);
            size += RepeatedSFixed64().CalculateSize(ListSFixed64_2, 282);
            size += RepeatedDouble().CalculateSize(ListDouble_2, 290);
            size += RepeatedFloat().CalculateSize(ListFloat_2, 298);
            size += RepeatedBool().CalculateSize(ListBoolean_2, 306);
            size += RepeatedEnum<SAMPLE_NUMBER>().CalculateSize(ListEnum_2, 314);
            size += RepeatedDateTime().CalculateSize(ListDateTime_2, 346);
            size += RepeatedTimeSpan().CalculateSize(ListTimeSpan_2, 354);
            size += RepeatedUri().CalculateSize(ListUri_2, 362);
            size += RepeatedGuid().CalculateSize(ListGuid_2, 370);
            ...
            while ((tag = ctx.ReadTag()) != 0)
            {
                ...
                switch (tag)
                {
                    ...
                    case 186:
                        ...
                        break;
                    case 194:
                        RepeatedString().Read(ref ctx, ref ListTextAlias_2, 194);
                        break;
                    case 202:
                        RepeatedBytes().Read(ref ctx, ref ListBytes_2, 202);
                        break;
                    case 210:
                    case 208:
                        RepeatedInt32().Read(ref ctx, ref ListInt32_2, 210);
                        break;
                    case 218:
                    case 216:
                        RepeatedInt64().Read(ref ctx, ref ListInt64_2, 218);
                        break;
                    case 226:
                    case 224:
                        RepeatedUInt32().Read(ref ctx, ref ListUInt32_2, 226);
                        break;
                    case 234:
                    case 232:
                        RepeatedUInt64().Read(ref ctx, ref ListUInt64_2, 234);
                        break;
                    case 242:
                    case 240:
                        RepeatedSInt32().Read(ref ctx, ref ListSInt32_2, 242);
                        break;
                    case 250:
                    case 248:
                        RepeatedSInt64().Read(ref ctx, ref ListSInt64_2, 250);
                        break;
                    case 258:
                    case 261:
                        RepeatedFixed32().Read(ref ctx, ref ListFixed32_2, 258);
                        break;
                    case 266:
                    case 265:
                        RepeatedFixed64().Read(ref ctx, ref ListFixed64_2, 266);
                        break;
                    case 274:
                    case 277:
                        RepeatedSFixed32().Read(ref ctx, ref ListSFixed32_2, 274);
                        break;
                    case 282:
                    case 281:
                        RepeatedSFixed64().Read(ref ctx, ref ListSFixed64_2, 282);
                        break;
                    case 290:
                    case 289:
                        RepeatedDouble().Read(ref ctx, ref ListDouble_2, 290);
                        break;
                    case 298:
                    case 301:
                        RepeatedFloat().Read(ref ctx, ref ListFloat_2, 298);
                        break;
                    case 306:
                    case 304:
                        RepeatedBool().Read(ref ctx, ref ListBoolean_2, 306);
                        break;
                    case 314:
                    case 312:
                        RepeatedEnum<SAMPLE_NUMBER>().Read(ref ctx, ref ListEnum_2, 314);
                        break;
                    case 346:
                    case 344:
                        RepeatedDateTime().Read(ref ctx, ref ListDateTime_2, 346);
                        break;
                    case 354:
                    case 352:
                        RepeatedTimeSpan().Read(ref ctx, ref ListTimeSpan_2, 354);
                        break;
                    case 362:
                        RepeatedUri().Read(ref ctx, ref ListUri_2, 362);
                        break;
                    case 370:
                        RepeatedGuid().Read(ref ctx, ref ListGuid_2, 370);
                        break;
                    case 378:
    ...
    public partial class AllTypesDataTable : Table, IMessage<AllTypesDataTable>, IBufferMessage
    {
        #region Proto.Field
        ...
        {
            MetaNestedData.SetupIntWrapper(new MapIntWrapper<AllTypesData>(Map));
        }
    ...
    public partial class BoxData : Data, IMessage<BoxData>, IBufferMessage
    {
        ...
        void IBufferMessage.InternalWriteTo(ref WriteContext ctx)
        {
            ...
            {
                ctx.WriteRawTag(26);
                ctx.WriteString(NameAlias);
            }
            RepeatedMessage<BoxSlot>().Write(ref ctx, ref List, 34);
        }
        ...
        public int CalculateSize()
        {
            ...
            if (NameAlias.Length != 0)
            {
                size += 1 + ComputeStringSize(NameAlias);
            }
            size += RepeatedMessage<BoxSlot>().CalculateSize(List, 34);
            return size;
        }
            ...
            while ((tag = ctx.ReadTag()) != 0)
            {
                ...
                switch (tag)
                {
                    ...
                    case 18:
                        ...
                        break;
                    case 26:
                        NameAlias = ctx.ReadString();
                        break;
                    case 34:
                        RepeatedMessage<BoxSlot>().Read(ref ctx, ref List, 34);
                        break;
                }
            }
        }
    ...
    public partial class EmptyData : Data, IMessage<EmptyData>, IBufferMessage
    {
        #region Proto.Field
        public int Id;
        public string IdAlias = "";
    ...
    public partial class EmptyDataTable : Table, IMessage<EmptyDataTable>, IBufferMessage
    {
        #region Proto.Field
        ...
        {
            MetaNestedData.SetupIntWrapper(new MapIntWrapper<EmptyData>(Map));
        }
    ...
    public partial class EmptyInfo : Data, IMessage<EmptyInfo>, IBufferMessage
    {
        #region Proto.Field
        public int Id;
        public string IdAlias = "";
